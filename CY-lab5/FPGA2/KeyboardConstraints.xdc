...
set_property PACKAGE_PIN U17 [get_ports Bottom]
set_property IOSTANDARD LVCMOS33 [get_ports Bottom]

#LEDs
set_property PACKAGE_PIN L1 [get_ports {enable[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {enable[3]}]
set_property PACKAGE_PIN P1 [get_ports {enable[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {enable[2]}]
set_property PACKAGE_PIN N3 [get_ports {enable[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {enable[1]}]
set_property PACKAGE_PIN P3 [get_ports {enable[0]}]
...
set_property PACKAGE_PIN U17 [get_ports Bottom_in]
set_property PACKAGE_PIN U18 [get_ports Center_in]
set_property PACKAGE_PIN W19 [get_ports Left_in]
set_property PACKAGE_PIN T17 [get_ports Right_in]
set_property PACKAGE_PIN T18 [get_ports Top_in]
set_property IOSTANDARD LVCMOS33 [get_ports Top_in]
set_property IOSTANDARD LVCMOS33 [get_ports Right_in]
set_property IOSTANDARD LVCMOS33 [get_ports Left_in]
set_property IOSTANDARD LVCMOS33 [get_ports Center_in]
set_property IOSTANDARD LVCMOS33 [get_ports Bottom_in]
